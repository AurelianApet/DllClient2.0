...
namespace DLLClient
{
    public partial class Form1 : Form
    {
        ...
        private static extern IntPtr fnbgRemove(StringBuilder imgBase64,int top, int left, int width, int height, int iterations);
        ...
        private void btnRemoveBG_Click(object sender, EventArgs e)
        {
            ...
            IntPtr retimg = fnbgRemove(img64, top,left, width, height,iterations);
